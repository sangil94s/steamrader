	...
	return (
		<div className="grid grid-cols-4 justify-items-center gap-2">
			{CardLists && CardLists.map((item:ITypes) => (
				<div className="border border-slate-200 rounded-lg w-full flex items-center gap-4 hover:bg-gray-400 transition" key={item.id}>
					<Image src={'/temps.png'} width={90} height={90} alt="썸네일 이미지" className="m-2 rounded-2xl object-cover" />
